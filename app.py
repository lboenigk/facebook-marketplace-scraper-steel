...
#latest work seems to stop here. The div classes likely change between sessions, hence why it doesn't work. Consider using an "nth child" logic to get the right div class. this code also doesn't navigate into each post, where there's a lot more information. consider adding this. 
        ...
        print("❌ Exception caught in /crawl_facebook_marketplace:")
